# Operator Quickstart — Community Freight Transport

Shortest path from clone to a verified local dry-run for **ISIC 4920** (`cloud-itonami-isic-4920`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4920.git
cd cloud-itonami-isic-4920
```
...
- Blueprint governor key: `freight-governor`
- Likely source path: `freightops.governor.cljc`
